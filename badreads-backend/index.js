...
var app = express();
mongoose.connect('mongodb://mongo-0.mongo,mongo-1.mongo:27017/badReads',{auth: {"authSource": "admin"}, user: "admin", pass: "123456", useNewUrlParser: true, useUnifiedTopology: true });
